...
import Context, { ContextError } from './index';
import { ServerResponse } from 'http';
import { CacheContentTypes as getType, IsJson as isJSON, ErrorInject as ensureErrorHandler, StreamDestroy as destroy } from '@nelts/utils';
...
export default class Response<M, C extends Context<M, B, F>, B = any, F = any> {
  ...
  redirect(url: string, alt?: string) {
    // location
    if ('back' == url) url = this.ctx.request.get('Referrer') as string || alt || '/';
